      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <p className="text-[#a7a7af] text-base sm:text-lg mb-6 lg:text-xl">
           I am a skilled and passionate Web Developer with experience in creating visually appealing and <span className="block">user-friendly applications. </span> 
          </p>
          <div>
            <Link
              href="/contact"
              className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-primary-400 to-secondary-500 hover:bg-slate-200 text-white hover:scale-110 duration-300"
            >
             CONTACT ME
            </Link>
            <Link
